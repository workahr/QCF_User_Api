...
class _StorePageState extends State<StorePage> {
  ...
  //       // });
  //       setState(() {
  //         int cartItemIndex = cartList.indexWhere(
  //           (item) =>
  ...
  //         if (cartItemIndex != -1) {
  //           cartList[cartItemIndex] = CartListData(
  //             cartId: cartList[cartItemIndex].cartId,
  ...
  //           );
  //         } else {
  //           cartList.add(CartListData(
  //             cartId: 0,
  //             productId: int.parse(productid),
  //             storeId: int.parse(storeid),
  //             quantity: 1,
  //             price: "100",
  //             quantityPrice: (1 * 100).toStringAsFixed(2),
  //             storePrice: '0',
  //             storeTotalPrice: '0',
  //             status: 1,
  //           ));
    ...
    try {
      ...
      if (response.status.toString() == 'SUCCESS') {
        setState(() {
          ...
          // Decrement quantity and update quantityPrice
          if (cartItem.quantity > 1) {
            cartItem.quantity -= 1;
            cartItem.quantityPrice =
                (cartItem.quantity * (double.tryParse(cartItem.price) ?? 0))
                    .toStringAsFixed(2);
          } else {
